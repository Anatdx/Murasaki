...
import com.anatdx.murasaki.server.ConfigPackageEntry;

public class MurasakiConfig {
    ...
    public MurasakiConfig() {
    }

    public MurasakiConfig(@NonNull List<PackageEntry> packages) {
