...
import com.anatdx.murasaki.starter.ServiceStarter;
import rikka.hidden.compat.PackageManagerApis;
import rikka.hidden.compat.UserManagerApis;
import com.anatdx.murasaki.server.UserServiceManager;
import com.anatdx.murasaki.server.UserServiceRecord;

public class MurasakiUserServiceManager extends UserServiceManager {
    ...
    public MurasakiUserServiceManager() {
        super();
    }
    ...
    public String getUserServiceStartCmd(
        ...
        return ServiceStarter.commandForUserService(
                appProcess,
                MurasakiService.getManagerApplicationInfo().sourceDir,
