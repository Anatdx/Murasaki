...
import com.anatdx.murasaki.starter.util.IContentProviderCompat;
import com.anatdx.murasaki.server.UserService;
import rikka.hidden.compat.ActivityManagerApis;

public class ServiceStarter {

    private static final String TAG = "MurasakiServiceStarter";
    ...
    private static final String USER_SERVICE_CMD_FORMAT = "(CLASSPATH='%s' %s%s /system/bin " +
            "--nice-name='%s' com.anatdx.murasaki.starter.ServiceStarter " +
    ...
    private static boolean sendBinder(IBinder binder, String token, boolean retry) {
        String packageName = "com.anatdx.murasaki";
        ...
        try {
            ...
            extra.putString(MurasakiApiConstants.USER_SERVICE_ARG_TOKEN, token);
