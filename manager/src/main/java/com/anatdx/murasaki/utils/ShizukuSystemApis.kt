package com.anatdx.murasaki.utils
...
import com.anatdx.murasaki.MurasakiBinderWrapper

object ShizukuSystemApis {

    init {
        SystemServiceBinder.setOnGetBinderListener {
            return@setOnGetBinderListener MurasakiBinderWrapper(it)
        }
    }
