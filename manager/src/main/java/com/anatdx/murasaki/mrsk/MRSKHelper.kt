...
object MRSKHelper {
    ...
    fun tryReceiveBinderFromReid(context: Context): Boolean {
        ...
        Murasaki.onBinderReceived(binder, context.packageName)
        return true
    }
