        ...
        try {
            ...
            if (uid != 0) {
                val dialog = MaterialAlertDialogBuilder(context)
                        .setTitle(R.string.app_management_dialog_permission_limited_title)
                        .setMessage(context.getString(R.string.app_management_dialog_permission_limited_message, Helps.HOME.get()).toHtml(HtmlCompat.FROM_HTML_OPTION_TRIM_WHITESPACE))
